<template>
  ...
  <el-form-item label="Song Kh Name" prop="khName">
    <el-input v-model="ruleForm.khName"></el-input>
  </el-form-item>
  <el-form-item label="Song Name" prop="name">
    <el-input v-model="ruleForm.name"></el-input>
  </el-form-item>
  <el-form-item label="Song Desc" prop="desc">
  ...
  <div class="el-upload__tip" slot="tip">MP3 files with a size less than 5MB</div>
</el-upload>
  </el-form-item>
  <el-form-item>
